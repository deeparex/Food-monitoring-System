...
const FoodItemSchema = new mongoose.Schema({
  ...
  currentStage: String,  // Current stage of the supply chain (e.g., Harvested, Processed, Shipped)
...
// MongoDB connection
mongoose
  .connect('mongodb://localhost:27017/supplyChainQuality', { useNewUrlParser: true, useUnifiedTopology: true })
...
app.get('/api/food/:traceId', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      traceId: foodItem.traceId,
      qualityAlerts,
      currentStage: foodItem.currentStage,
...
// Endpoint to update food item traceability and quality data at a specific stage in the supply chain
